...
from ohmlectrum_gui.kivy.uix.dialogs import EventsDialog
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from ohmlectrum.mnemonic import Mnemonic
        from ohmlectrum.old_mnemonic import words as old_wordlist
