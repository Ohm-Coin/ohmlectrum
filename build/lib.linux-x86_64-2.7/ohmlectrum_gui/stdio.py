...
from ohmlectrum.util import format_satoshis, set_verbosity
from ohmlectrum.bitcoin import is_valid, COIN, TYPE_ADDRESS
from ohmlectrum.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'ohmlectrum create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'ohmlectrum setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'ohmlectrum setconfig' to change your settings")
        return True
