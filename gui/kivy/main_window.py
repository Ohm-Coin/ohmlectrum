...
import ohmlectrum as electrum
from ohmlectrum.bitcoin import TYPE_ADDRESS
from ohmlectrum import WalletStorage, Wallet
from ohmlectrum_gui.kivy.i18n import _
from ohmlectrum.paymentrequest import InvoiceStore
from ohmlectrum.util import profiler, InvalidPassword
from ohmlectrum.plugins import run_hook
from ohmlectrum.util import format_satoshis, format_satoshis_plain
...
Factory.register('InstallWizard',
                 module='ohmlectrum_gui.kivy.uix.dialogs.installwizard')
Factory.register('InfoBubble', module='ohmlectrum_gui.kivy.uix.dialogs')
Factory.register('OutputList', module='ohmlectrum_gui.kivy.uix.dialogs')
Factory.register('OutputItem', module='ohmlectrum_gui.kivy.uix.dialogs')
...
# the data
Cache.register('ohmlectrum_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='ohmlectrum_gui.kivy.uix.screens')
...
from ohmlectrum.util import base_units
...
class ElectrumWindow(App):
    ...
    def on_qr(self, data):
        from ohmlectrum.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from ohmlectrum.transaction import Transaction
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from ohmlectrum.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='ohmlectrum_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='ohmlectrum_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('ohmlectrum_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('ohmlectrum_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/ohmlectrum.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Ohmlectrum', message,
                            app_icon=icon, app_name='Ohmlectrum')
        except ImportError:
