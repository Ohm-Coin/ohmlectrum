...
try:
    ...
    from ohmlectrum.bitcoin import TYPE_ADDRESS, var_int, msg_magic, Hash, verify_message, public_key_to_p2pkh, EncodeAES, DecodeAES
    from ohmlectrum.i18n import _
    from ohmlectrum.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from ohmlectrum.util import print_error
