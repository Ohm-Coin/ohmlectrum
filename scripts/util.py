import select, time, ohmlectrum as electrum, Queue
from ohmlectrum import Connection, Interface, SimpleConfig
from ohmlectrum.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    server = 'ohmlectrum.bysh.me:50002:s'
