...
from ohmlectrum import Wallet, WalletStorage
from ohmlectrum.util import UserCancelled, InvalidPassword
from ohmlectrum.base_wizard import BaseWizard
...
MSG_ENTER_ANYTHING = _("Please enter a seed phrase, a master key, a list of "
                       "Ohm addresses, or a list of private keys")
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Ohmlectrum  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon(':icons/ohmlectrum.png')
        self.show()
        self.raise_()
